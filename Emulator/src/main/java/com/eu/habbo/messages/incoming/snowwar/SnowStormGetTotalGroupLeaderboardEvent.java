...
/** AIR TotalGroupLeaderboardTable (1776): the all-time guild ranking. */
public class SnowStormGetTotalGroupLeaderboardEvent extends SnowStormLeaderboardEvent {
    @Override
    ...
    protected int responseHeader() {
        return Outgoing.Game2TotalGroupLeaderboardComposer;
    }
}
