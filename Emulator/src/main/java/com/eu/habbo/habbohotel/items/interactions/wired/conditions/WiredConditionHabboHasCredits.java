...
/**
 * Passes when the resolved user holds at least {@code amount} credits - the positive half of
 * {@link WiredConditionHabboLacksCredits}, which was the only half the emulator had. A furni named
 * {@code wf_cnd_habbo_has_credits} was on sale pointing at the negative class, so a builder who asked
 * for "the user has credits" got a box that passed only when they did not.
 *
