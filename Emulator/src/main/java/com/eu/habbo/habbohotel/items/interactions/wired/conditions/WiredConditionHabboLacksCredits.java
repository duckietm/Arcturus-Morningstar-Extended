...
/**
 * Passes when the resolved user's credits do NOT compare to {@code amount} as the operator says - the
 * opposite of {@link WiredConditionHabboHasCredits} with the same settings. It keeps
...
public class WiredConditionHabboLacksCredits extends WiredConditionTeamGameBase {
    ...
    public WiredConditionHabboLacksCredits(
